    ...
    <div ref={containerRef} className="min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50/30 text-gray-900 overflow-x-hidden">
      ...
      <section id="contact" className="relative py-32 px-6">
        <div className="max-w-6xl mx-auto">
          ...
          >
            <div>
              <h2 className="text-5xl md:text-6xl font-bold mb-8 tracking-tight">Collaborate with the Vanguard</h2>
              <p className="text-lg text-gray-600 mb-10 leading-relaxed font-light">
                Tell us about your vision. We orchestrate elite teams of engineers, designers, and AI savants to materialize the future you imagine.
              </p>
              ...
              <div className="space-y-6 text-gray-600">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Manifest Your Vision</p>
                    <p>Share your ambitions and we&apos;ll architect the journey.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Precision Execution</p>
                    <p>Our specialists craft, iterate, and refine until the extraordinary emerges.</p>
                  </div>
                </div>
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <p className="font-semibold text-gray-900">Enduring Partnership</p>
                    <p>We evolve alongside you, ensuring every milestone is surpassed.</p>
                  </div>
                </div>
              </div>
              ...
              <motion.a
                ...
                className="mt-10 inline-flex items-center gap-3 text-blue-700 font-semibold text-lg"
              >
            ...
            >
              <div className="relative w-80 h-80 flex items-center justify-center">
                ...
                >
                  ...
                  <div className="absolute inset-0 rounded-full bg-gradient-to-br from-white/20 via-transparent to-white/10 mix-blend-overlay" />
                </motion.div>
              </div>
            </motion.div>
          </motion.div>
      ...
      {/* Footer */}
      <footer className="relative py-12 px-6 border-t border-white/40 bg-white/60 backdrop-blur-md">
        <div className="max-w-7xl mx-auto flex flex-col md:flex-row gap-6 md:items-center md:justify-between text-gray-500 text-sm">
          <p>© {new Date().getFullYear()} Marsfront Studio. Crafted on Earth, inspired by Mars.</p>
